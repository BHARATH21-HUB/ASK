...
dec = [(np.sum(d2[i*bd:(i+1)*bd]**2) > np.sum(d1[i*bd:(i+1)*bd]**2)) for i in range(br)]
...
<img width="1225" height="1110" alt="image" src="https://github.com/user-attachments/assets/b0da3cdc-ab5b-4272-b06c-4b48c52bef46" />

## FSK

<img width="1111" height="1107" alt="image" src="https://github.com/user-attachments/assets/7a474f9c-ffa3-4fa7-8dd9-4232bad7ba03" />
